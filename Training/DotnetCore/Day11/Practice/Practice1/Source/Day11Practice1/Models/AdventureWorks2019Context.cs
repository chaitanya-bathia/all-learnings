...
namespace Day11Practice1.Models
{
    public partial class AdventureWorks2019Context : DbContext
    {
        ...
        public virtual DbSet<VwGetProductAndCostDetail> VwGetProductAndCostDetails { get; set; }
        public virtual DbSet<VwPersonDetail> VwPersonDetails { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=PC0352\\MSSQL2019;Database=AdventureWorks2019;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Borrow>(entity =>
            {
                entity.HasKey(e => e.Loanno)
                    .HasName("PK__Borrow__D98B45132E821A92");
            ...
            modelBuilder.Entity<Branch>(entity =>
            {
                entity.HasKey(e => e.Bname)
                    .HasName("PK__Branch__C670A8F9AB19C724");
            ...
            modelBuilder.Entity<CourseEnrolled>(entity =>
            {
                ...
                entity.HasOne(d => d.Student)
                    ...
                    .HasConstraintName("FK_CourseEnrolled_Student");
            });
            ...
            modelBuilder.Entity<Customer>(entity =>
            {
                entity.HasKey(e => e.Cname)
                    .HasName("PK__CUSTOMER__C38B56B93AF893F8");
            ...
            modelBuilder.Entity<FeePayment>(entity =>
            {
                ...
                entity.HasOne(d => d.Student)
                    .WithMany()
                    .HasForeignKey(d => d.StudentId)
                    .HasConstraintName("FK_FeePayment_Student");
            });
            ...
            modelBuilder.Entity<LogTable>(entity =>
            {
                entity.HasKey(e => e.LogId)
                    .HasName("PK__LogTable__5E5499A8C1E0A27D");
            ...
            modelBuilder.Entity<VwGetProductAndCostDetail>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vwGetProductAndCostDetails");
